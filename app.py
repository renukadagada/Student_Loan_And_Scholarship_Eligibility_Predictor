...
# --- Extra features (fill with actual names from your dataset) ---
feature12 = st.number_input("Feature 12",0,100, step=1)
feature13 = st.number_input("Feature 13",0,100, step=1)
feature14 = st.number_input("Feature 14",0,100, step=1)
feature15 = st.number_input("Feature 15",0,100, step=1)
...
if st.button("Predict"):
    ...
    input_data = np.array([[age, gender, gpa, attendance, extra, income,
                            ...
                            feature12, feature13, feature14, feature15]], dtype=float)
